...
import org.betterx.wover.recipe.impl.SyncedRecipesImpl;
...
public final class SyncedRecipes {
    ...
    /** Registers a custom recipe type for NeoForge's recipe-content synchronization. */
    public static void registerType(RecipeType<?> type) {
        SyncedRecipesImpl.registerType(type);
    }
