 ...
 * {@link org.betterx.wover.datagen.api.provider.WoverRecipeProvider}).
 * <p>
...
public class RecipeBuilder {
     ...
     * {@link org.betterx.wover.datagen.api.provider.WoverRecipeProvider}; it should not usually be constructed
    ...
    public record Context(HolderLookup.Provider lookupProvider, HolderGetter<Item> itemLookup,
        ...
        public Context(HolderLookup.Provider lookupProvider, RecipeProvider recipeProvider, RecipeOutput recipeOutput) {
            this(lookupProvider, lookupProvider.lookupOrThrow(Registries.ITEM), recipeOutput);
        }
        ...
        /**
         * Creates a context for callers using the legacy recipe-provider API, where only the
         * recipe output is passed through. The active datagen lookup is reused when available;
         * otherwise the built-in item registry provides the item holders required by vanilla
         * recipe builders.
         *
         * @param itemLookup  The item lookup to use while building the recipe.
         * @param recipeOutput The output the finished recipe is written to.
         */
        public Context(HolderGetter<Item> itemLookup, RecipeOutput recipeOutput) {
            this(null, itemLookup, recipeOutput);
        }
        ...
        public Criterion<?> has(Item value) {
            return InventoryChangeTrigger.TriggerInstance.hasItems(value);
        }
        ...
        public Criterion<?> has(TagKey<Item> value) {
            return InventoryChangeTrigger.TriggerInstance.hasItems(
                    ItemPredicate.Builder.item().of(this.itemLookup, value)
            );
        }
        ...
        public Ingredient tag(TagKey<Item> in) {
            return Ingredient.of(this.itemLookup.getOrThrow(in));
        }
    }
