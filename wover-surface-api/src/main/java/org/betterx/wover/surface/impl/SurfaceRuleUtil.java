...
public class SurfaceRuleUtil {
    ...
    private static List<SurfaceRules.RuleSource> getCompatRulesForDimension(
        ...
        if (!LevelStem.END.equals(dimensionKey)) return List.of();
        ...
        if (!hasEnderscapeBiome) return List.of();

        final SurfaceRules.RuleSource rules = tryBuildEnderscapeSurfaceRules();
    ...
    private static SurfaceRules.RuleSource tryBuildEnderscapeSurfaceRules() {
        try {
            ...
            if (result instanceof SurfaceRules.RuleSource ruleSource) return ruleSource;
    ...
    public static void injectNoiseBasedSurfaceRules(
        ...
        if (o instanceof SurfaceRuleProvider srp) {
            ...
            if (!compatRules.isEmpty()) additionalRules.addAll(0, compatRules);
