...
public abstract class TypeBiomeDecider extends BiomeDecider {
   ...
   protected TypeBiomeDecider(HolderLookup<Biome> biomeRegistry, ResourceKey<Biome> fallbackBiome, TagKey<Biome> assignedType) {
   ...
   public boolean canProvideBiome(TagKey<Biome> suggestedType) {
      return suggestedType.equals(this.assignedType);
   }
}
